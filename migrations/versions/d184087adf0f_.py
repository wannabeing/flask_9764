...
Revision ID: d184087adf0f
Revises: e1e1dc0c61dc
Create Date: 2021-11-25 11:55:32.096964
...
revision = 'd184087adf0f'
down_revision = 'e1e1dc0c61dc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(batch_op.f('uq_user_sec_joo'), ['sec_joo'])
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(batch_op.f('uq_user_sec_joo'), type_='unique')
        batch_op.drop_column('tel')

    op.create_table('_alembic_tmp_user',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('tel', sa.VARCHAR(length=50), nullable=False),
